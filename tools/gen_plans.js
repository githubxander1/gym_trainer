...
const PLANS = [
  {
    ...
    items: [
      ex('哑铃上斜卧推', 4, 'rep', 8, 50), ex('哑铃站姿交替过顶推举', 3, 'rep', 10, 40),
      ex('哑铃卧推', 4, 'rep', 8, 50), ex('哑铃窄握推举', 3, 'rep', 10, 35),
      ex('哑铃下斜卧推', 3, 'rep', 12, 45), ex('哑铃侧上举', 3, 'rep', 12, 30),
      ex('哑铃飞鸟', 3, 'rep', 12, 30),
      ex('哑铃站姿俯身双臂三头屈伸', 3, 'rep', 12, 30), ex('凳臂屈伸', 3, 'rep', 10, 35),
    ],
  ...
  },
  {
    ...
    items: [
      ex('绳索高位下拉', 4, 'rep', 10, 45), ex('哑铃二头弯举', 3, 'rep', 12, 30),
      ex('哑铃俯身划船', 4, 'rep', 12, 45), ex('死虫', 3, 'rep', 12, 30),
      ex('引体向上', 3, 'rep', 8, 50), ex('哑铃锤式弯举', 3, 'rep', 12, 30),
      ex('哑铃上斜划船', 3, 'rep', 12, 40), ex('俄罗斯转体', 3, 'rep', 16, 30),
      ex('超伸展', 3, 'rep', 12, 40),
    ],
  ...
  },
  {
    ...
    items: [
      ...
      ex('哑铃高脚杯深蹲', 4, 'rep', 12, 50), ex('哑铃站姿提踵', 4, 'rep', 15, 30),
      ex('哑铃罗马尼亚硬拉', 4, 'rep', 12, 50), ex('侧弓步蹲', 4, 'rep', 12, 35),
      ex('哑铃后箭步蹲', 3, 'rep', 10, 45), ex('哑铃登阶箭步蹲', 3, 'rep', 10, 45),
    ],
