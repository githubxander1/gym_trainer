...
const PLANS = [
  {
    ...
    items: [
      ...
      ex('哑铃反向飞鸟', 3, 'rep', 15, 25), ex('哑铃站姿俯身单臂三头屈伸', 3, 'rep', 12, 25),
      ex('凳臂屈伸', 3, 'rep', 10, 30), ex('哑铃站姿交替过顶推举', 3, 'rep', 10, 35),
      ex('哑铃下斜卧推', 3, 'rep', 12, 40), ex('哑铃上斜卧推', 4, 'rep', 8, 40),
      ex('哑铃卧推', 4, 'rep', 8, 55),
    ],
  ...
  },
  {
    ...
    items: [
      ...
      ex('负重俄罗斯转体', 3, 'rep', 20, 25), ex('悬垂腿上举', 3, 'rep', 12, 30),
      ex('哑铃俯身划船', 4, 'rep', 12, 35), ex('哑铃单臂俯身划船', 3, 'rep', 12, 35),
      ex('引体向上', 4, 'rep', 10, 45),
    ],
  ...
  },
  {
    ...
    items: [
      ...
      ex('哑铃直腿硬拉', 3, 'rep', 12, 35), ex('哑铃单腿硬拉', 3, 'rep', 12, 35),
      ex('哑铃箭步蹲', 3, 'rep', 12, 35), ex('哑铃高脚杯深蹲', 5, 'rep', 20, 40),
    ],
