...
const PLANS = [
  ...
  },
  {
    ...
    items: [
      ...
      ex('哑铃二头弯举', 3, 'rep', 12, 25), ex('前平板支撑转体', 3, 'time', 45, 20),
    ],
    cooldown: [ st('背阔肌拉伸', '双手上举交扣，向一侧侧屈 20 秒', 20), st('跑者拉伸', '小腿后侧拉伸', 20, '跑者拉伸') ],
  },
  {
    id: 'fri-legs', name: '周五·腿臀日（腿/臀/核心）', tags: ['增肌', '腿臀'], level: '新手',
    ...
    items: [
      ...
      ex('侧弓步蹲', 3, 'rep', 12, 30), ex('自重站姿提踵', 3, 'rep', 15, 25), ex('俄罗斯转体', 3, 'rep', 20, 25),
    ],
    cooldown: [ st('腘绳肌拉伸', '坐姿或站姿勾脚前屈 20 秒', 20, '腿上腘绳肌拉伸'), st('臀桥拉伸', '仰卧抱单膝靠近胸部 20 秒', 20), st('跑者拉伸', '小腿后侧拉伸', 20, '跑者拉伸') ],
  },
  {
    id: 'cardio-hiit', name: '有氧燃脂（HIIT）', tags: ['有氧', '减脂'], level: '新手',
  ...
  {
    id: 'bodyweight', name: '徒手健身（全身自重）', tags: ['徒手', '全身'], level: '新手',
    intro: '不用器械，靠自重覆盖全身。适合在家或出差。引体可用门框杆或弹力带辅助。',
    warmup: [ st('动态激活', '触趾 + 手臂画圈 + 体转 各 1 分钟', 90) ],
    items: [
      ex('深俯卧撑', 3, 'rep', 12, 30), ex('宽握引体向上', 3, 'rep', 8, 30), ex('自重站姿提踵', 3, 'rep', 15, 25),
  ...
  {
    id: 'dumbbell', name: '哑铃健身（全身哑铃）', tags: ['哑铃', '全身'], level: '新手',
  ...
  {
    id: 'ladies', name: '女士塑形（臀腿/核心/上肢）', tags: ['女士', '臀腿'], level: '新手',
  ...
  {
    id: 'pelvic', name: '盆底与性能力强化', tags: ['凯格尔', '盆底'], level: '专项',
    intro: '围绕盆底肌（凯格尔）安排，主打「盆底激活 → 协同肌群唤醒」。无需器械，随时可练。',
    warmup: [ st('骨盆前后倾激活', '站立缓慢做骨盆前倾↔后倾 15 次，唤醒盆底与核心', 60) ],
    items: [
      st('凯格尔·快速收缩', '收紧盆底肌后立即放松，快收快放 ×15 次', 60),
      st('凯格尔·慢速保持', '收紧保持 5 秒 → 放松 5 秒，重复 ×10 次', 90),
      st('站立骨盆倾斜', '站立位缓慢做骨盆前倾↔后倾 ×15，唤醒盆底与核心', 90),
      st('骨盆倾斜', '仰卧屈膝，腰部贴地后放松 ×15', 90),
      ex('低臀桥地面', 3, 'rep', 15, 15),
    ],
    cooldown: [ st('骨盆放松摆动', '站立或仰卧，轻柔摆动骨盆 30 秒', 30) ],
  },
];
