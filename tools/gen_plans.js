...
const PLANS = [
  {
    ...
    items: [
      ex('哑铃上斜卧推', 4, 'rep', 8, 40), ex('哑铃卧推', 4, 'rep', 8, 40),
      ex('哑铃下斜卧推', 3, 'rep', 12, 40), ex('哑铃站姿交替过顶推举', 3, 'rep', 10, 35),
      ex('哑铃飞鸟', 3, 'rep', 12, 30), ex('哑铃侧上举', 3, 'rep', 12, 30),
      ex('哑铃窄握推举', 3, 'rep', 10, 30), ex('哑铃站姿俯身双臂三头屈伸', 3, 'rep', 12, 30),
      ex('凳臂屈伸', 3, 'rep', 10, 30),
    ],
  ...
  },
  {
    ...
    items: [
      ex('引体向上', 4, 'rep', 10, 40), ex('哑铃俯身划船', 4, 'rep', 12, 35),
      ex('哑铃上斜划船', 3, 'rep', 12, 35), ex('哑铃反向飞鸟', 3, 'rep', 12, 30),
  ...
  },
  {
    ...
    items: [
      ex('侧髋外展', 3, 'rep', 15, 30), ex('低臀桥地面', 3, 'rep', 15, 30),
      ex('哑铃高脚杯深蹲', 4, 'rep', 12, 40), ex('哑铃罗马尼亚硬拉', 4, 'rep', 12, 40),
      ex('哑铃后箭步蹲', 3, 'rep', 10, 40), ex('哑铃登阶箭步蹲', 3, 'rep', 10, 40),
      ex('哑铃站姿提踵', 5, 'rep', 15, 30), ex('侧弓步蹲', 4, 'rep', 12, 30),
    ],
