...
const PLANS = [
  ...
  },
  {
    ...
    items: [
      ...
      ex('侧桥', 3, 'time', 30, 40),
      ex('俄罗斯转体', 3, 'rep', 16, 30), ex('超伸展', 3, 'rep', 12, 40),
    ],
  ...
  },
  {
    ...
    items: [
      ex('侧髋外展', 3, 'rep', 15, 30), ex('低臀桥地面', 4, 'rep', 15, 35),
      ex('哑铃高脚杯深蹲', 4, 'rep', 12, 50), ex('哑铃站姿提踵', 4, 'rep', 15, 30),
      ex('哑铃罗马尼亚硬拉', 4, 'rep', 12, 50), ex('侧弓步蹲', 3, 'rep', 12, 35),
      ex('哑铃单腿硬拉', 3, 'rep', 10, 45), ex('反向腿弯举', 3, 'rep', 10, 45),
    ],
