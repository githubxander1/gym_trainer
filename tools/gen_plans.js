...
const PLANS = [
  {
    ...
    items: [
      ...
      ex('绳索站姿后三角肌划船', 3, 'rep', 15, 25), ex('凳臂屈伸', 3, 'rep', 10, 30), ex('绳索下压', 3, 'rep', 12, 30),
      ex('钻石俯卧撑', 3, 'rep', 12, 30),
    ],
  ...
  },
  {
    ...
    items: [
      ex('引体向上', 4, 'rep', 10, 30), ex('绳索站姿划船', 4, 'rep', 15, 30), ex('哑铃单臂俯身划船', 4, 'rep', 12, 30),
      ex('哑铃二头弯举', 3, 'rep', 12, 25), ex('哑铃锤式弯举', 3, 'rep', 12, 25),
      ex('卷腹', 4, 'rep', 15, 25), ex('悬垂腿上举', 3, 'rep', 12, 25),
    ],
  ...
  },
  {
    ...
    items: [
      ex('哑铃直腿硬拉', 3, 'rep', 12, 30), ex('哑铃箭步蹲', 3, 'rep', 12, 30), ex('侧弓步蹲', 3, 'rep', 12, 30),
      ex('低臀桥地面', 3, 'rep', 15, 30), ex('哑铃单腿硬拉', 3, 'rep', 12, 30),
      ex('哑铃站姿提踵', 3, 'rep', 15, 25), ex('俄罗斯转体', 3, 'rep', 20, 25), ex('徒手深蹲', 5, 'rep', 20, 30),
    ],
