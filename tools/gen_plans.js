...
const PLANS = [
  {
    ...
    items: [
      ...
      ex('哑铃侧上举', 3, 'rep', 12, 30), ex('哑铃站姿交替过顶推举', 3, 'rep', 10, 30), ex('凳臂屈伸', 3, 'rep', 10, 30),
      ex('绳索下压', 3, 'rep', 12, 30), ex('钻石俯卧撑', 3, 'rep', 12, 30),
    ],
  ...
  },
  {
    ...
    items: [
      ...
      ex('哑铃锤式弯举', 3, 'rep', 12, 25), ex('前平板支撑转体', 3, 'time', 45, 20),
    ],
  ...
  },
  {
    ...
    items: [
      ...
      ex('自重站姿提踵', 3, 'rep', 15, 25), ex('俄罗斯转体', 3, 'rep', 20, 25),
    ],
