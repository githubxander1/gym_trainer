...
const PLANS = [
  {
    id: 'mon-push', name: '周一 · 胸·肩·手臂', tags: [], level: '进阶',
    ...
    items: [
      ex('哑铃飞鸟', 3, 'rep', 12, 25), ex('哑铃侧上举', 3, 'rep', 12, 25),
      ex('绳索站姿后三角肌划船', 3, 'rep', 15, 25), ex('绳索下压', 3, 'rep', 12, 25),
      ex('哑铃坐姿反握单臂过顶三头伸展', 3, 'rep', 12, 25), ex('凳臂屈伸', 3, 'rep', 10, 30),
      ex('哑铃站姿交替过顶推举', 3, 'rep', 10, 35), ex('哑铃下斜卧推', 3, 'rep', 12, 40),
      ex('哑铃上斜卧推', 4, 'rep', 8, 40), ex('杠铃卧推', 4, 'rep', 8, 55),
    ],
    cooldown: [ st('胸大肌拉伸', '靠门框或墙，手臂外展贴墙，身体前压 20 秒', 20), st('三头肌拉伸', '单臂过头顶屈肘，另一手轻压肘 20 秒', 20), st('跑者拉伸', '小腿后侧拉伸', 20, '跑者拉伸') ],
  },
  {
    id: 'wed-pull', name: '周三 · 背·臂·核心', tags: [], level: '进阶',
    ...
    items: [
      ex('哑铃二头弯举', 3, 'rep', 12, 30), ex('哑铃锤式弯举', 3, 'rep', 12, 30),
      ex('绳索俄罗斯转体', 3, 'rep', 20, 25), ex('悬垂腿上举', 3, 'rep', 12, 30),
      ex('绳索站姿划船', 4, 'rep', 12, 35), ex('哑铃单臂俯身划船', 3, 'rep', 12, 35),
      ex('杠铃俯身划船', 4, 'rep', 10, 50), ex('引体向上', 4, 'rep', 10, 45),
    ],
    cooldown: [ st('背阔肌拉伸', '双手上举交扣，向一侧侧屈 20 秒', 20), st('跑者拉伸', '小腿后侧拉伸', 20, '跑者拉伸') ],
  },
  {
    id: 'fri-legs', name: '周五 · 腿·臀', tags: [], level: '进阶',
    ...
    items: [
      ex('哑铃站姿提踵', 3, 'rep', 15, 25), ex('俄罗斯转体', 3, 'rep', 20, 25), ex('低臀桥地面', 3, 'rep', 15, 25),
      ex('侧弓步蹲', 3, 'rep', 12, 30), ex('哑铃直腿硬拉', 3, 'rep', 12, 35),
      ex('哑铃单腿硬拉', 3, 'rep', 12, 35), ex('哑铃高脚杯深蹲', 5, 'rep', 20, 40), ex('哑铃箭步蹲', 3, 'rep', 12, 40),
    ],
  ...
  },
  {
    ...
    warmup: [ st('动态激活', '肩部环绕 + 徒手深蹲感 2 分钟', 120) ],
    items: [
