...
const PLANS = [
  {
    ...
    items: [
      ...
      ex('哑铃上斜卧推', 4, 'rep', 8, 40), ex('哑铃下斜卧推', 3, 'rep', 12, 40),
      ex('哑铃卧推', 4, 'rep', 8, 55), ex('哑铃站姿交替过顶推举', 3, 'rep', 10, 35),
      ex('哑铃窄握推举', 3, 'rep', 10, 30), ex('哑铃站姿俯身双臂三头屈伸', 3, 'rep', 12, 25),
      ex('凳臂屈伸', 3, 'rep', 10, 30),
    ],
  ...
  },
  {
    ...
    items: [
      ex('引体向上', 4, 'rep', 10, 45), ex('哑铃俯身划船', 4, 'rep', 12, 35),
      ex('哑铃上斜划船', 3, 'rep', 12, 35), ex('哑铃上拉', 3, 'rep', 12, 30),
      ex('哑铃二头弯举', 4, 'rep', 12, 30), ex('哑铃锤式弯举', 4, 'rep', 12, 30),
      ex('哑铃集中弯举', 3, 'rep', 12, 25), ex('哑铃反握二头弯举', 3, 'rep', 12, 25),
    ],
  ...
  },
  {
    ...
    items: [
      ex('低臀桥地面', 3, 'rep', 15, 25), ex('哑铃站姿提踵', 3, 'rep', 15, 25),
      ex('哑铃高脚杯深蹲', 5, 'rep', 20, 40), ex('哑铃箭步蹲', 3, 'rep', 12, 35),
      ex('哑铃后箭步蹲', 3, 'rep', 12, 35), ex('哑铃登阶箭步蹲', 3, 'rep', 12, 35),
      ex('侧弓步蹲', 3, 'rep', 12, 30), ex('哑铃直腿硬拉', 3, 'rep', 12, 35),
      ex('哑铃单腿硬拉台阶支撑', 4, 'rep', 12, 35),
    ],
